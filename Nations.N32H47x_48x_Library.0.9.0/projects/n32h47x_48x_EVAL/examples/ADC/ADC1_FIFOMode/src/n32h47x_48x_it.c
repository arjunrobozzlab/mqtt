...
*\*\fun     This function handles ADC1 and ADC2 Handler.
*\*\return  None
**/
void ADC1_2_IRQHandler(void)
{
   if(ADC_GetFIFOFlagStatus(ADC1,ADC_FIFO_FLAG_HALF_FULL))
   {
        ADC_ClearFIFOIntPendingBit(ADC1,ADC_FIFO_INT_HALF_FULL);
   }
