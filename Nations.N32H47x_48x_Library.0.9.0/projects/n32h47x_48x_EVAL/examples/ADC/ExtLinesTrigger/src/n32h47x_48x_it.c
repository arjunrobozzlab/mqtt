...
void ADC1_2_IRQHandler(void)
{
    if(ADC_GetIntStatus(ADC1,ADC_INT_JENDC) != RESET)
    {
        ...
        /* Get injected channel1 and channel2 converted value */
        ADC_InjectedConvertedValueTab[Index++] = ADC_GetInjectedConversionDat(ADC1, ADC_INJECT_DATA_OFFSET_1);
        ADC_InjectedConvertedValueTab[Index++] = ADC_GetInjectedConversionDat(ADC1, ADC_INJECT_DATA_OFFSET_2);
