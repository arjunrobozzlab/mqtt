...
#ifndef __FEMC_PSRAM_H__
#define __FEMC_PSRAM_H__

#include "n32h47x_48x.h"

#define Bank1_Block1_PSRAM_ADDR ((uint32_t)0x60000000) // 0x60000000~63FFFFFF
#define Bank1_Block2_PSRAM_ADDR ((uint32_t)0x64000000) // 0x64000000~67FFFFFF
#define Bank1_Block3_PSRAM_ADDR ((uint32_t)0x68000000) // 0x68000000~6BFFFFFF
#define Bank1_Block4_PSRAM_ADDR ((uint32_t)0x6C000000) // 0x6C000000~6FFFFFFF
...
void FEMC_Psram_Init(uint8_t bank_num);
