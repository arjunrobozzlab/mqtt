...
int main(void)
{
    ...
    The objective is to get TIMx counter clock at x MHz:
     - Prescaler = (TIMxCLK / TIMx counter clock) - 1
    CC1 update rate = TIMx counter clock / CCR1_Val
    CC2 update rate = TIMx counter clock / CCR2_Val
    CC3 update rate = TIMx counter clock / CCR3_Val
    CC4 update rate = TIMx counter clock / CCR4_Val
    */
    ...
    /* TIM IT enable */
    TIM_ConfigInt(TIMx, TIM_INT_CC1 | TIM_INT_CC2 | TIM_INT_CC3 | TIM_INT_CC4, ENABLE);   
