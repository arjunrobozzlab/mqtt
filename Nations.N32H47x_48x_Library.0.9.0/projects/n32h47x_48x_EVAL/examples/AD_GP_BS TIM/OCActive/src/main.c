...
int main(void)
{
    ...
    The objective is to get TIM3 counter clock at x Hz:
     - Prescaler = (TIMxCLK / TIMx counter clock) - 1
    And generate 4 signals with 4 different delays:
    TIMx_CH1 delay = CCR1_Val/TIMx counter clock 
    TIMx_CH2 delay = CCR2_Val/TIMx counter clock 
    TIMx_CH3 delay = CCR3_Val/TIMx counter clock 
    TIMx_CH4 delay = CCR4_Val/TIMx counter clock 
    */
    ...
    TIM_ConfigOc1Preload(TIMx, TIM_OC_PRE_LOAD_DISABLE);
    ...
    TIM_ConfigOc2Preload(TIMx, TIM_OC_PRE_LOAD_DISABLE);  
    ...
    TIM_ConfigOc3Preload(TIMx, TIM_OC_PRE_LOAD_DISABLE);
    ...
    TIM_ConfigOc4Preload(TIMx, TIM_OC_PRE_LOAD_DISABLE);
...
void RCC_Configuration(void)
{
    ...
    RCC_EnableAHB1PeriphClk(RCC_AHB_PERIPHEN_GPIOA | TIMx_CH1_GPIO_CLK |\
                            TIMx_CH2_GPIO_CLK | TIMx_CH3_GPIO_CLK |\
                            TIMx_CH4_GPIO_CLK,ENABLE);
