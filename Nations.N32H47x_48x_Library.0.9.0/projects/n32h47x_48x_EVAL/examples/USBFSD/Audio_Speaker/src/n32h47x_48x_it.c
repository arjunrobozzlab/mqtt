...
/** N32H47X Peripherals Interrupt Handlers, interrupt handler's name please refer to the startup file (startup_n32h47x_48x.s) **/
/**
*\*\name    USB_HP_IRQHandler.
*\*\fun     This function handles USB_HP_IRQHandler Handler.
*\*\param   none
*\*\return  none 
**/
void USB_FS_HP_IRQHandler(void)
{
    USB_CorrectTransferHp();
}
