...
extern uint8_t* get_mouse_pos(void);
/**
*\*\name    SysTick_Handler.
...
/** N32H47X_48X Peripherals Interrupt Handlers, interrupt handler's name please refer to the startup file (startup_n32h47x_48x.s) **/
