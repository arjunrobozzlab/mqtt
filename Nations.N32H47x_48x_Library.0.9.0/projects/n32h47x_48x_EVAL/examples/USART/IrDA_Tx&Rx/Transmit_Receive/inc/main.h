...
#define USARTy_GPIO             GPIOG
#define USARTy_GPIO_CLK         RCC_AHB_PERIPHEN_GPIOG
#define USARTy_TxPin            GPIO_PIN_6
#define USARTy_Tx_GPIO_AF       GPIO_AF17
#define USARTy_APBxClkCmd       RCC_EnableAPB1PeriphClk

#define USARTz                  UART5
#define USARTz_CLK              RCC_APB1_PERIPH_UART5
#define USARTz_GPIO             GPIOH
#define USARTz_GPIO_CLK         RCC_AHB_PERIPHEN_GPIOH
...
#define USARTy_Rx_GPIO_AF       GPIO_AF18
#define USARTy_Tx_GPIO_AF       GPIO_AF17
#define USARTy_APBxClkCmd       RCC_EnableAPB1PeriphClk
