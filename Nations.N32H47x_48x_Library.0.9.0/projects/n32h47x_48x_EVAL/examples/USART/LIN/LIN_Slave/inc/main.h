...
#define USARTx_GPIO             GPIOH
#define USARTx_GPIO_CLK         RCC_AHB_PERIPHEN_GPIOH
#define USARTx_RxPin            GPIO_PIN_3
#define USARTx_TxPin            GPIO_PIN_2
#define USARTx_Rx_GPIO_AF       GPIO_AF21
#define USARTx_Tx_GPIO_AF       GPIO_AF20
#define GPIO_AHBClkCmd          RCC_EnableAHB1PeriphClk
...
#define USARTx_GPIO_CLK         RCC_AHB_PERIPHEN_GPIOA
#define USARTx_RxPin            GPIO_PIN_3
#define USARTx_TxPin            GPIO_PIN_2
#define USARTx_Rx_GPIO_AF       GPIO_AF21
#define USARTx_Tx_GPIO_AF       GPIO_AF20
