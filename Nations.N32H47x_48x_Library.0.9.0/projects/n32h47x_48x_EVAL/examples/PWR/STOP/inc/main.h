...
#define KEY_EXTI_LINE_SOURCE     EXTI_LINE_SOURCE2
#define KEY_GPIO_PIN_SOURCE      GPIO_PIN_SOURCE2
#define KEY_EXTI_IRQn            EXTI2_IRQn
#define KEY_EXTI_IRQHandler      EXTI2_IRQHandler
...
#define KEY_EXTI_LINE_SOURCE     EXTI_LINE_SOURCE0
#define KEY_GPIO_PIN_SOURCE      GPIO_PIN_SOURCE0
