...
#define USARTy_GPIO_CLK         RCC_AHB_PERIPHEN_GPIOB
#define USARTy_RxPin            GPIO_PIN_5
#define USARTy_TxPin            GPIO_PIN_3
#define USARTy_Rx_GPIO_AF       GPIO_AF15
#define USARTy_Tx_GPIO_AF       GPIO_AF9
#define USARTy_DAT_Base         (USART2_BASE + 0x10)
