...
/**
*\*\name    DMA1_Channel1_IRQHandler.
*\*\fun     This function handles DMA1 CH1 request.
*\*\param   none
*\*\return  none
**/
void DMA1_Channel1_IRQHandler(void)
{
    if (DMA_GetIntStatus(DMA_INT_TXC1, DMA1) != RESET)
    {
        DMA_ClrIntPendingBit(DMA_INT_TXC1, DMA1);
        log_info("DMA read CORDIC register complete.\n");
    }
}

/**
*\*\name    DMA1_Channel2_IRQHandler.
*\*\fun     This function handles DMA1 CH2 request.
*\*\param   none
*\*\return  none
**/
void DMA1_Channel2_IRQHandler(void)
{
    if (DMA_GetIntStatus(DMA_INT_TXC2, DMA1) != RESET)
    {
        DMA_ClrIntPendingBit(DMA_INT_TXC2, DMA1);
        log_info("DMA write CORDIC register complete.\n");
    }
}
