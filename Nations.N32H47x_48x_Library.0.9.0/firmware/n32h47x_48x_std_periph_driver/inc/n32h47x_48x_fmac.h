...
/**
*\*\file n32h47x_48x_fmac.h
*\*\author Nations
*\*\version v1.0.0
*\*\copyright Copyright (c) 2023, Nations Technologies Inc. All rights reserved.
**/
#ifndef __N32H47X_FMAC_H
#define __N32H47X_FMAC_H
...
#define FMAC_WDATA_WDATA                 ((uint32_t)0x0000FFFF)                   /* ??????????????? */
#define FMAC_FUNC_LOADX1                 ((uint32_t)0x01000000)                   /* Load X1 buffer */
#define FMAC_FUNC_LOADX2                 ((uint32_t)0x02000000)                   /* Load X2 buffer */
#define FMAC_FUNC_LOADY                  ((uint32_t)0x03000000)                   /* Load Y buffer  */
#define FMAC_FUNC_CONVO_FIR              ((uint32_t)0x08000000)                   /* Convolution (FIR filter)   */
#define FMAC_FUNC_IIR_DIRECT_FORM_1      ((uint32_t)0x09000000)                   /* IIR filter (direct form 1)  */

#define FMAC_THRESHOLD1                   0x00000000U           /* Input: Buffer full flag set if the number of free spaces in the buffer is less than 1.
                                                                  Output: Buffer empty flag set if the number
                                                                  of unread values in the buffer is less than 1. */
#define FMAC_THRESHOLD2                   0x01000000U           /* Input: Buffer full flag set if the number of free spaces in the buffer is less than 2.
                                                                  Output: Buffer empty flag set if the number
                                                                  of unread values in the buffer is less than 2. */
#define FMAC_THRESHOLD4                   0x02000000U           /* Input: Buffer full flag set if the number of free spaces in the buffer is less than 4.
                                                                  Output: Buffer empty flag set if the number
                                                                  of unread values in the buffer is less than 4. */
#define FMAC_THRESHOLD8                   0x03000000U          /* Input: Buffer full flag set if the number of free spaces in the buffer is less than 8.
                                                                  Output: Buffer empty flag set if the number
...
#define FMAC_LIMIT_DISABLE                0x00000000U           /* Limit disabled */
#define FMAC_LIMIT_ENABLE                 FMAC_CTRL_LIMITEN   /* Limit enabled */

#define FMAC_START                        FMAC_PARAMCFG_START  /* Enable execution */
#define FMAC_RESET                        FMAC_CTRL_RESET      /* Reset filter mathematical accelerator unit */                      
...
#define FMAC_INT_FLAG_YBUFEF              ((uint8_t)0x00U)                /*!< Y buffer empty interrupt flag */
#define FMAC_INT_FLAG_X1BUFFF             ((uint8_t)0x01U)                /*!< X1 buffer full interrupt flag */
#define FMAC_INT_FLAG_OVF                 ((uint8_t)0x02U)                /*!< Overflow error interrupt flag */
#define FMAC_INT_FLAG_UNF                 ((uint8_t)0x03U)                /*!< underflow error interrupt flag */
#define FMAC_INT_FLAG_SATF                ((uint8_t)0x04U)                /*!< saturation error interrupt flag */
