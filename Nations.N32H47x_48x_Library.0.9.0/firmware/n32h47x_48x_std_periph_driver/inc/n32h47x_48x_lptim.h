...
/**
*\*\file n32h47x_48x_lptim.h
*\*\author Nations
*\*\version v1.0.0
*\*\copyright Copyright (c) 2023, Nations Technologies Inc. All rights reserved.
**/ 

#ifndef __N32H47X_LPTIM_H__
#define __N32H47X_LPTIM_H__
...
#define LPTIM_TRIG_SOURCE_COMP5     ((uint32_t)LPTIM_CFG_TRGSEL_3 \
                                             | LPTIM_CFG_TRGSEL_1) /* External input trigger is connected to COMP5 output */
#define LPTIM_TRIG_SOURCE_COMP6     ((uint32_t)LPTIM_CFG_TRGSEL_3 \
                                             | LPTIM_CFG_TRGSEL_1 \
                                             | LPTIM_CFG_TRGSEL_0) /* External input trigger is connected to COMP6 output */
#define LPTIM_TRIG_SOURCE_COMP7     ((uint32_t)LPTIM_CFG_TRGSEL_3 \
                                             | LPTIM_CFG_TRGSEL_2) /* External input trigger is connected to COMP7 output */
...
#define LPTIM_INPUT1_CONNECT_COMP1 ((uint32_t)LPTIM_OPT_OPT1_0) /* Input1 connected to COMP1_OUT */
#define LPTIM_INPUT1_CONNECT_COMP2 ((uint32_t)LPTIM_OPT_OPT1_1) /* Input1 connected to COMP2_OUT */
#define LPTIM_INPUT1_CONNECT_COMP3 ((uint32_t)LPTIM_OPT_OPT1_0 \
                                            | LPTIM_OPT_OPT1_1) /* Input1 connected to COMP3_OUT */
#define LPTIM_INPUT1_CONNECT_COMP4 ((uint32_t)LPTIM_OPT_OPT1_2) /* Input1 connected to COMP4_OUT */
#define LPTIM_INPUT1_CONNECT_COMP5 ((uint32_t)LPTIM_OPT_OPT1_0 \
                                            | LPTIM_OPT_OPT1_2) /* Input1 connected to COMP5_OUT */
#define LPTIM_INPUT1_CONNECT_COMP6 ((uint32_t)LPTIM_OPT_OPT1_1 \
                                            | LPTIM_OPT_OPT1_2) /* Input1 connected to COMP6_OUT */
#define LPTIM_INPUT1_CONNECT_COMP7 ((uint32_t)LPTIM_OPT_OPT1_0 \
                                            | LPTIM_OPT_OPT1_1 \
                                            | LPTIM_OPT_OPT1_2) /* Input1 connected to COMP7_OUT */

/** LPTIM Input2 connected option definition **/
#define LPTIM_INPUT2_CONNECT_GPIO  ((uint32_t)0x00000000U)      /* Input2 connected to GPIO */
#define LPTIM_INPUT2_CONNECT_COMP1 ((uint32_t)LPTIM_OPT_OPT2_0) /* Input2 connected to COMP1_OUT */
#define LPTIM_INPUT2_CONNECT_COMP2 ((uint32_t)LPTIM_OPT_OPT2_1) /* Input2 connected to COMP2_OUT */
#define LPTIM_INPUT2_CONNECT_COMP3 ((uint32_t)LPTIM_OPT_OPT2_0 \
                                            | LPTIM_OPT_OPT2_1) /* Input2 connected to COMP3_OUT */
#define LPTIM_INPUT2_CONNECT_COMP4 ((uint32_t)LPTIM_OPT_OPT2_2) /* Input2 connected to COMP4_OUT */
#define LPTIM_INPUT2_CONNECT_COMP5 ((uint32_t)LPTIM_OPT_OPT2_0 \
                                            | LPTIM_OPT_OPT2_2) /* Input2 connected to COMP5_OUT */
#define LPTIM_INPUT2_CONNECT_COMP6 ((uint32_t)LPTIM_OPT_OPT2_1 \
                                            | LPTIM_OPT_OPT2_2) /* Input2 connected to COMP6_OUT */
#define LPTIM_INPUT2_CONNECT_COMP7 ((uint32_t)LPTIM_OPT_OPT2_0 \
                                            | LPTIM_OPT_OPT2_1 \
                                            | LPTIM_OPT_OPT2_2) /* Input2 connected to COMP7_OUT */
...
uint32_t LPTIM_IsActiveIntStatus(LPTIM_Module* LPTIMx, uint32_t IntStatus);
