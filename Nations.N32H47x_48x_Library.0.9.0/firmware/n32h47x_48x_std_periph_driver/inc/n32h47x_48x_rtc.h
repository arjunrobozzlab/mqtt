...
/**
*\*\file n32h47x_48x_rtc.h
*\*\author Nations
*\*\version v1.0.0
*\*\copyright Copyright (c) 2023, Nations Technologies Inc. All rights reserved.
**/

#ifndef __N32H47X_RTC_H__
#define __N32H47X_RTC_H__
...
#define RTC_FLAGS_MASK                           ((uint32_t)(RTC_FLAG_RECPF | RTC_FLAG_TAMP3F | RTC_FLAG_TAMP2F | RTC_FLAG_TAMP1F | RTC_FLAG_TISOVF | RTC_FLAG_TISF | RTC_FLAG_WTF | RTC_FLAG_ALBF | RTC_FLAG_ALAF | RTC_FLAG_INITF        \
...
#define RTC_TAMPER_ERASE_1      RTC_TMPCFG_TP1NOE    /* Tamper detection enable for input tamper 1 */
#define RTC_TAMPER_ERASE_2      RTC_TMPCFG_TP2NOE    /* Tamper detection enable for input tamper 2 */
#define RTC_TAMPER_ERASE_3      RTC_TMPCFG_TP3NOE    /* Tamper detection enable for input tamper 3 */
