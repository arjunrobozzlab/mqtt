...
void USBH_Init(USB_CORE_MODULE *USBx, USBH_HOST *phost, USBH_Class_cb_TypeDef *class_cb, USBH_User_cb_TypeDef *usr_cb);
               
USBH_Status USBH_DeInit(USB_CORE_MODULE *USBx, USBH_HOST *phost);
void USBH_Main_Process(USB_CORE_MODULE *USBx, USBH_HOST *phost);
